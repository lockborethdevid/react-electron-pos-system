...
function Order() {
    const [modalOrderTableShow, setOrderTableShow] = React.useState(false);

    return (
        <div className="d-flex flex-column m-2">
            <div className="d-flex flex-row justify-content-between">
                <Button style={{ backgroundColor: "#D9D9D9", border: "none", color: "#00000" }} size="sm" className="px-3 text-dark"   onClick={() => setOrderTableShow(true)}>
            ...
            <OrderTable
                show={modalOrderTableShow}
                onHide={() => setOrderTableShow(false)}
            />
